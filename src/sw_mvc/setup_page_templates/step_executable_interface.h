...
typedef void (*ExecutableCallback_T)(StepExecutable *parent_sequence, RunModel *model);
typedef gboolean (*ExecutableConditionCallback_T)(StepExecutable *parent_sequence, RunModel *model);

struct _StepExecutableInterface
{
   GTypeInterface g_iface;
   void (*execute) (StepExecutable *self, RunModel *model);
   StepExecutable *(*get_next)(StepExecutable *self, RunModel *model);
